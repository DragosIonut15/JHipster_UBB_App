...
/**
 * REST controller for managing {@link nohaidragos.domain.Departament}.
 */
@RestController
@RequestMapping("/api")
public class DepartamentResource {
    ...
    public ResponseEntity<Departament> createDepartament(@Valid @RequestBody Departament departament) throws URISyntaxException {
    ...
    public ResponseEntity<Departament> updateDepartament(@Valid @RequestBody Departament departament) throws URISyntaxException {
    ...
    public ResponseEntity<List<Departament>> getAllDepartaments(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
