...
describe('Service Tests', () => {
  describe('Departament Service', () => {
    let injector: TestBed;
    let service: DepartamentService;
    let httpMock: HttpTestingController;
    let elemDefault: IDepartament;
    let expectedResult;
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(DepartamentService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Departament(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Departament', async () => {
        const returnedFromService = Object.assign(
          {
            numeDepartament: 'BBBBBB'
          },
