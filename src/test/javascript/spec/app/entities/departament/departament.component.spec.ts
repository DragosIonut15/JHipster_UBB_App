...
import { DepartamentComponent } from 'app/entities/departament/departament.component';
...
describe('Component Tests', () => {
  describe('Departament Management Component', () => {
    let comp: DepartamentComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DepartamentComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.departaments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
