...
import nohaidragos.config.audit.AuditEventConverter;
import nohaidragos.domain.PersistentAuditEvent;
...
import static nohaidragos.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
